...
public class EntrainActivty extends BaseActivity {


    private CollectionReference bookRef = UserHelper.getUsersCollection().document(getCurrentUser().getUid()).collection("CurrentlyReding");
